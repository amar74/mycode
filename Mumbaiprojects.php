<?php
	...
	$sql="select * from projects where city='mumbai'";
...
<body id="top">
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/cons13.png'); height:410px;"> 
  <!-- ################################################################################################ -->
  ...
  <main class="hoc container clear"> 
    ...
    <div class="btmspace-80 center">
      <h3 class="nospace hed">Projects in Mumbai</h3>
