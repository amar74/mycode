...
<link href="layout/styles/gurgaonprojects.css" rel="stylesheet" type="text/css" media="all">
</head>
<body id="top">
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/work1.png'); height:400px;"> 
  ...
  <div class="wrapper row1">
    <header id="header" class="hoc clear"> 
      ...
      <nav id="mainav" class="fl_right">
		...
		<li style="font-weight:600;"><span class=""><a href="Portfolio.html">Portfolio</a></span></li>
          <li style="font-weight:600;"><span class=""><a href="Contactus.html">Contact Us</a></span></li>
        </ul>
      </nav>
  ...
  <main class="hoc container clear"> 
    <div class="btmspace-80 center">
      <h3 class="nospace hed">Projects in Gurgaon</h3>
	  <p class="nospace" style="font-size:17px;">Find your home in 12+ cities in India</p>
    </div>
	<div class="row" style=" padding:20px 0px; background:#f3f3f3;">
		<div class="col-md-4"><img src="images/demo/backgrounds/proj4.png" style="width:100%; height:350px; margin:auto;"></div>
		<div class="col-md-8">
			<div class="" style="width:100%; height:350px; margin:auto;">
				<span style="width:250px;  float:left; margin:0; padding:0px; font-size:17px; color:#000; border-right:1px solid #CCC;">Happy Appartment<br>Cannaught Place, New Delhi</span>
				<span style="float:left ; margin-left:30px; padding:0px; font-size:17px; color:#000;">PropMatterz Developer </span>
				<div style="width:100%; height:auto; position:relative; top:40px;">
				<table class="table" style="text-align:center;">
					<tbody >
					<tr >
					<td >1BHK</td><td>512 - 612 sqft</td><td>32.4 Lac - 32.4 Lac</td>
					</tr>
					<tr >
					<td>2BHK</td><td>1000 - 1220 sqft</td><td>50.4 Lac - 52.2 Lac</td>
					</tr>
					<tr>
					<td>3BHK</td><td>1512 - 1702 sqft</td><td>82.3 Lac - 83.2 Lac</td>
					</tr>
					</tbody>
				</table>	
				</div>
			<div style="width:100%; height:auto;  position:relative; top:40px; padding:10px; 0px 5px 0px">
					...
					<p style="">asajsas sajsj<br>asajsas sajsj</p>
	...
	<div class="row" style="margin-top:50px; padding:20px 0px; background:#f3f3f3;">
		<div class="col-md-4"><img src="images/demo/backgrounds/proj2.png" style="width:100%; height:350px; margin:auto;"></div>
